 ...
 * @since 2021/9/13
 */
public class DiffValueTypeSerializer extends JsonSerializer<DiffValueType> {

  @Override
  public void serialize(DiffValueType value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    if (value == null) {
