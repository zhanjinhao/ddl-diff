 ...
 * @since 2021/9/13
 */
public class DiffValueOrderSerializer extends JsonSerializer<DiffValueOrder> {

  @Override
  public void serialize(DiffValueOrder value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    if (value == null) {
