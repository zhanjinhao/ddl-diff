 ...
 * @since 2021/9/13
 */
public class DiffValueStringSerializer extends JsonSerializer<DiffValueString> {

  @Override
  public void serialize(DiffValueString value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    if (value == null) {
