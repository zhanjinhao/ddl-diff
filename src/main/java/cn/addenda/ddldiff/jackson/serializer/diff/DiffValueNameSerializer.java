 ...
 * @since 2021/9/13
 */
public class DiffValueNameSerializer extends JsonSerializer<DiffValueName> {

  @Override
  public void serialize(DiffValueName value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    if (value == null) {
